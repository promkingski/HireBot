...
- Contact with carter should be directed to the LinkedIn on the home page
...
async def about(request: Request):
    return templates.TemplateResponse(name="about.html", request=request, context={"active": "about"})
